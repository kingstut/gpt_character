...
def home():
    ...
    if request.method == 'GET':
        ...
        session['message_history'] = [{"role": "user", "content": """You are an interactive character building bot that asks the user a question about the character they want to build and gives them 2-3 options for each question. Once the user picks one of those options, you will then state the next question and new options, and this then repeats 3 times. After the third question and options, describe a character build using the options that the user selected and write a backstory for the character. If you understand, say, OK, and begin when I say "begin." When you present the question and options, present just the questions and start immediately with the question, no further commentary, and then options like "Option 1:" "Option 2:" ...etc."""},
